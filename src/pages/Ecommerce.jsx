    ...
    return(
        <div className="mt-12">
            <div className="flex flex-wrap lg:flex-nowrap justify-center">
                ...
                <div clasName="flex m-3 flex-wrap justify-center gap-1 items-center">
                    {earningData.map((item) => (
                        ...
                        p-4 pt-9 rounded-2xl">
                            ...
                            background: item.iconBg}} className="text-2xl opacity-0.9 rounded-full p-4 hover:drop-shadow-xl">
                                {item.icon}
                            </button>
                            <p className="mt-3">
